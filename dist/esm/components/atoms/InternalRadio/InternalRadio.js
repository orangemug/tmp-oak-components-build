import e,{forwardRef as r,useRef as o}from"react";import t,{css as s}from"styled-components";import{parseBorderRadius as d}from"../../../styles/helpers/parseBorderRadius.js";import{parseColor as a}from"../../../styles/helpers/parseColor.js";import{parseDropShadow as n}from"../../../styles/helpers/parseDropShadow.js";import{borderStyle as i}from"../../../styles/utils/borderStyle.js";import{colorStyle as c}from"../../../styles/utils/colorStyle.js";import{sizeStyle as l}from"../../../styles/utils/sizeStyle.js";import{spacingStyle as p}from"../../../styles/utils/spacingStyle.js";const u=t(r(((r,t)=>{const{onHovered:s,...d}=r,a=o(Date.now());return e.createElement("input",{ref:t,type:"radio",onMouseEnter:()=>{a.current=Date.now()},onMouseLeave:()=>{const e=Date.now()-a.current;s&&s(r.value,r.id,e)},...d})})))`
...
`,t(m)`
  ${h}
`;export{u as InternalRadio,m as InternalRadioHover};
